...
Text will be automatically XML-escaped for safe embedding.
Smart quotes (&#x201C; etc.) are preserved through the encoding pipeline.
...
# ━━━ XML escaping for user-provided text ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
_XML_ESCAPE_MAP = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;"}


def _xml_escape(text: str) -> str:
    """Escape user-provided text for safe embedding in XML elements."""
    return re.sub(r'[&<>"\']', lambda m: _XML_ESCAPE_MAP.get(m.group(0), m.group(0)), text)
...
def _generate_hex_id() -> str:
    """Generate a cryptographically-safe hex ID (29-bit range for OOXML compliance)."""
    return f"{secrets.randbelow(0x7FFFFFFF):08X}"
