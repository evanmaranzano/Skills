#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""双人对谈 TTS 生成（通用版）：读 beats.json → edge-tts 逐句合成 →
...
用法：
  python make_duo_tts.py --beats beats.json --out clips/
  python make_duo_tts.py --beats beats.json --out clips/ --voice-X zh-CN-XiaoxiaoNeural
"""
import argparse
import asyncio
import json
